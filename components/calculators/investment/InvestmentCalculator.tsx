...
const INVESTMENT_TYPES = [
  { id: 'mutual', name: 'Mutual Funds', avgReturn: 12, icon: '📊', description: '12% avg. return' },
  { id: 'stocks', name: 'Stocks', avgReturn: 15, icon: '📈', description: '15% avg. return' },
  { id: 'fixed', name: 'Fixed Deposits', avgReturn: 7, icon: '🏦', description: '7% avg. return' },
  { id: 'government', name: 'Government Bonds', avgReturn: 8, icon: '🏛️', description: '8% avg. return' },
  { id: 'corporate', name: 'Corporate Bonds', avgReturn: 9, icon: '💼', description: '9% avg. return' },
  { id: 'gold', name: 'Gold', avgReturn: 10, icon: '🪙', description: '10% avg. return' },
];
